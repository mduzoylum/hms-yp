...
class AnaKategoriController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $kategoriler = AnaKategori::all();
            return datatables()->of($kategoriler)
                ->addColumn('edit', function ($row) {
                    return "<a href='" . route('yonetim.anakategori.edit', $row->id) . "' class=\"btn btn-block btn-info btn-flat\">Düzenle</a>";
                })
                ->addColumn('delete', function ($row) {
                    return
                        "<form onclick='return confirm(\"Emin misin\")' action='" . route('yonetim.anakategori.destroy', $row->id) . "' method='post'>
                        " . csrf_field() . "
        ...
        return view('yonetim.ana_kategori.listele');
    }
    ...
    {
        return view('yonetim.ana_kategori.ekle');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('yonetim.anakategori.create');
        }
        AnaKategori::create([
    ...
    public function edit($id)
    {
        ...
        return view("yonetim.ana_kategori.duzenle", compact("kategori"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            Alert::error("Hata", $validator->errors()->first());
            return redirect()->route('yonetim.anakategori.index');
        }
