                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Ana Kategori Ekleme Paneli</h3>
                            </div>
                            <div class="card-body">
                                <table id="anakategoritable" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Kategori Adı</th>
                                        <th></th>
    ...
    <script>
        $(function () {
            $("#anakategoritable").DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{route('yonetim.anakategori.index')}}",
                columns: [
                    {data: 'ad'},
                    {
                        data: 'edit',
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                            location.href = "{{route('yonetim.anakategori.create')}}"
                        }
                    },
                    {
