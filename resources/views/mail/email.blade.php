                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                    <h2>Sayın <b>{{$data['ad']}} {{$data['soyad']}}, üye kaydnız alındı</b></h2>
                                    <h3>Sisteme giris yapabilmek için lütfen yöneticinin onaylamasını bekleyiniz</h3>
                                    <p><a href="{{route('auth.login')}}" class="btn btn-primary">HMS</a></p>
                                </div>
                            </td>
                        </tr>
                    </table>
